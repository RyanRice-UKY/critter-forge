    ...
    entries: [
      {
        ...
        match: /type\s*\(/,
        summary: "Every value has a type: str, int, float, or bool. type() names it.",
        syntax: "type(value)",
        parts: [["type", "the type checker"], ["( )", "hold any value up to it"], ["value", "what to measure"]],
      ...
      },
      {
        ...
        summary: "Casting converts a value to another type. int() cuts, it never rounds. input() always gives text, so cast before math.",
        syntax: "int(raw)",
        parts: [["int / float / str", "the target type"], ["( )", "hold the value to convert"], ["raw", "the value being converted"]],
